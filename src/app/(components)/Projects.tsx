  ...
  <div className="sm:flex sm:justify-evenly sm:mx-16 mt-20 ">
    <div className="sm:flex sm:flex-col flex justify-around ">
      {data.map((project) => (
        <div
          key={project.id}
          className="border-4 hover:border-gray-700 hover:shadow-lg hover:shadow-gray-600 rounded-full sm:w-32 sm:h-32 w-16 h-16 overflow-hidden sm:ml-12 ml-8 sm:mt-4"
